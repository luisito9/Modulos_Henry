...
autor.innerHTML += " Luis Viña";// le suma este string al ya existente

// #n === selecciona un TAG por su ID
// .n === selecciona TAGS por su clasen
// n === selecciona el primer tag que coincida con "h1"

// Crear una clase denominada 'ToDo' cuyo constructor debe recibir un único parámetro del 
//tipo string con el nombre 'description' que será justamente la descripción del ToDo.
...
// Tu código acá:
  ToDo.prototype.completeToDo = function () {// Esto es un metodo prototype de ToDo
